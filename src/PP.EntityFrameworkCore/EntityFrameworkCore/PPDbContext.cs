...
namespace PP.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See PPMigrationsDbContext for migrations.
     */
    [ConnectionStringName("Default")]
    public class PPDbContext : AbpDbContext<PPDbContext>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AppUser>(b =>
            {
                 ...
                 * Also see the PPEfCoreEntityExtensionMappings class
                 */
            });
